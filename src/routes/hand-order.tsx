...
function Hierarchy() {
    return (
        <>
            <h1>Suggested order of poker hands according to probability</h1>
            ...
            <p>
                Let's look at plots that analyze the probability when the player has 1–4 cards in their hand and uses
                them in their call. For every case we will assume the most probable distribution of ranks and suits
                as well as the most likely calls for every poker hand.
            </p>

            <h4>The player has 1 card</h4>
